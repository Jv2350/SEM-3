...
class BinarySearchVisualization:
    def __init__(self, root):  # noqa: F811
        ...
        self.entered_numbers = []  # Store entered numbers

        self.sort_button = tk.Button(root, text="Sort", command=self.sort_list, font=("Helvetica", 12), bg="light blue")
        self.sort_button.pack(pady=10)

        self.entered_numbers_canvas = tk.Canvas(root, width=600, height=50, bg="light gray")
